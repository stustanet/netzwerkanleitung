...
% Tex initially created by Maximilian Engelhardt <maximilian.engelhardt@stusta.de>
	...
	\item Under \optemph{Addresses} click on Add.
      \begin{figure}[h!]
        ...
        \begin{minipage}[c]{0.5\linewidth}
          \centering
          \includegraphics[width=\linewidth,keepaspectratio]{Bilder/IP_Ubuntu_EN_mb}
...
\begin{enumerate}
    ...
    \item At the bottom of the window, mark the automatic proxy configuration box and enter the auto-configuration URL: \url{http://wpad.mb67.stusta.de/proxy.pac}\ . Close the window to save the settings.
\end{enumerate}
