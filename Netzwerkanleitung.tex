...
Die Mitgliedschaft im StuStaNet~e.V. bietet viele Vorteile. Zum einen werden die Proxyeinstellungen in Kapitel \emph{\nameref{Proxy}} für Mitglieder hinfällig, da der StuStaNet~e.V. einen Masquerader betreibt. Außerdem wird Mitgliedern ein Emailkonto, ein Webspace mit PHP und Datenbank, einen Datenserver und vieles mehr  zur Verfügung gestellt \footnote{\url{https://wiki.stusta.de/Dienste}}.
\\
\\Die Mitgliedschaft kostet einmalig \EUR{20} und kann in den StuStaNet~e.V. Sprechstunden beantragt werden. Diese finden während des Semesters meist montags und donnerstags zwischen 19:00 und 19:30 Uhr im Blauen Haus im Erdgeschoss, Zimmer 0028 statt. Die genauen Termine können unter \url{https://sprechstunden.stusta.de.de/} eingesehen werden. Bitte registriere dich zuvor auf \url{https://reg.stusta.de}.
\\
...
\begin{center}
  \begin{tabularx}{\linewidth}{|lX|}
    ...
    \hline
    \url{https://info.stusta.mhn.de/} & Ankündigungen und allgemeine Informationen über die StuSta\\
    \hline
  \end{tabularx}
\end{center}
