...
\begin{center}
  \begin{tabularx}{\linewidth}{|lXp{.2\linewidth}|}
    ...
    \hline \hline
    IP-Adresse& \nolinkurl{10.143.xxx.yyy} - \nolinkurl{10.143.xxx.zzz} , \nolinkurl{10.142.xxx.yyy} - \nolinkurl{10.143.xxx.zzz}, \newline 13 Adressen stehen zur Auswahl\footnote{Auffindbar auf dem IP-Zettel, bei der Hausverwaltung oder in der Sprechstunde.} & \nolinkurl{10.142.128.16} – \nolinkurl{10.142.128.31} \\
    \hline
    Subnetzmaske & \nolinkurl{255.255.255.240} & \\
    \hline
    Subnetzpräfixlänge & \nolinkurl{28} & \\
    \hline
    Standardgateway & \nolinkurl{10.1.xxx.254} \newline (Die ersten drei Blöcke wie IP-Adresse, der vierte Block \nolinkurl{254}) & \nolinkurl{10.142.128.17} \\
    \hline
