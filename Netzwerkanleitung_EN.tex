...
You can join the StuStaNet~e.V. at one of our office hours, which are normally Mondays and Thursdays from 19.00 to 19.30 in the Blue House (House \#11), room 0028, during the semester (during breaks only Thursdays). The exact dates can be found at \url{https://sprechstunden.stusta.de}. Therefore, please register first at \url{reg.stusta.de}.
